Meteor.util = {
    ...
    isFileExtension: function (filename, extension) {
        var ending = Meteor.util.fileExtension(filename);
        if (ending !== null && extension !== null) {
            return ending.toLocaleLowerCase() === extension;
        }
        return false;
    },
